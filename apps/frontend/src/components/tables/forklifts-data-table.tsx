...
export const forkliftSchema = z.object({
  vin: z.string(),
  crd_no: z.string().optional().nullable(),
  truck_no: z.string().optional().nullable(),
  truck_type: z.string().optional().nullable(),
  company: z.string().optional().nullable(),
  work_hour: z.preprocess((v) => Number(v ?? 0), z.number()),
  first_conn: z.string().optional().nullable(),
  last_conn: z.string().optional().nullable(),
...
const columns: ColumnDef<z.infer<typeof forkliftSchema>>[] = [
  ...
  { accessorKey: "work_hour", header: "Work Hour" },
  {
  ...
  {
    accessorKey: "last_conn",
    header: "Last Connected",
    cell: ({ row }) =>
      row.original.last_conn
        ? new Date(row.original.last_conn).toLocaleString()
        : "",
  },
  {
    id: "actions",
